...
**Reason**: Superseded — the carryover-era exclusion of the 12 delegating/
DOM-scan composables ends with this change; they are rewritten pure-Vue and
exported. The "no framework globals" guard it carried is re-stated (and
strengthened) by the new `pure-rewrite-surface` requirement.
